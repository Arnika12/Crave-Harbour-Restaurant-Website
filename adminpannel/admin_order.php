    ...
    <div class="main-container">
        ...
        <section class="order-container">
            ...
            <div class="box-container">
                ...
                ?>
                <div class="box">
                    <div class="status" style="color: <?php echo $fetch_order['status'] == 'in progress' ? 'limegreen' : 'coral'; ?>">
                    ...
                    <div class="detail">
                        ...
                        <p>plcaed on : <span><?php echo $fetch_order['date']; ?></span></p>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <select name="update_payment">
                            ...
                            <option value="complete" <?php echo $fetch_order['payment_status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                        </select>
                        <div class="flex-btn">
